...
export default function Events({ initialEvents = [] }) {
  ...
  const translations = {
    ...
    kn: {
      ...
      subtitle: "(Events)",
      loading: "ಕಾರ್ಯಕ್ರಮಗಳು ಲೋಡ್ ಆಗುತ್ತಿದೆ...",
            ...
            {events.map((event, index) => (
              ...
              >
                ...
                <div className="p-4 bg-black/90 rounded-b-2xl flex-1 flex flex-col justify-between">
                  ...
                  {event.link && (
                    <div className="flex items-center gap-1 text-xs text-blue-400 mt-auto">
                      <svg
                        className="w-3 h-3"
                        fill="none"
                        stroke="currentColor"
                      ...
                      <a href={event.link} target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300">Link</a>
                    </div>
                  )}
                </div>
                ...
                <div className="modal-info-bar mt-6 px-8 py-6 w-full">
                  ...
                  {preview.link && (
                    <div className="flex items-center gap-2 text-blue-400">
                      ...
                      <a href={preview.link} target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300 font-medium">Event Link</a>
                    </div>
                  )}
                </div>
